...
! function(t, e) {
    ...
    var m = {
        ...
        selectOption(t) {
            ...
            this.trigger("dropdown:select", {
                ...
                __isValid: !0
            }, this.normalizeTags([n])[0])) : this["mix" == this.settings.mode ? "addMixTags" : "addTags"]([n], i), this.DOM.input.parentNode && (setTimeout((() => {
                    ...
                    if (n)
                        if (r) {
                            if (e = this.hasMaxTags(), i = this.getWhitelistItem(n) || d({}, o, {
                                    ...
                                    value: n,
                                    __isValid: l
                                }), s.transformTag.call(this, i, o), !0 !== (l = (!e || !0 === o.__isValid) && this.validateTag({
    ...
    return y.prototype = {
        ...
        tagData: (t, e, i) => t ? (e && (t.__tagifyTagData = i ? e : d({}, t.__tagifyTagData || {}, e)), t.__tagifyTagData) : (console.warn("tag element doesn't exist", t, e), e),
        isTagDuplicate(t, e) {
            var i = this.settings;
