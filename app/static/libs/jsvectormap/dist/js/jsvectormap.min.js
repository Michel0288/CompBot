! function(t, e) {
        ...
        M = function(t) {
            function e(e) {
                var i, s = e.map,
                    ...
                    h = e.labelStyle,
                    l = e.labelsGroup;
                (i = t.call(this) || this).canvas = s.canvas, i.map = s, i.shape = i.canvas.createPath({
                    d: n,
                    dataCode: a
    ...
    var _ = function() {
        function t(t) {
            ...
            this.shape = i.canvas.createLine({
                ...
                y2: o,
                dataIndex: e
            }, s, h), this.shape.addClass("jvm-line")
        }
        return t.prototype.setStyle = function(t, e) {
            this.shape.setStyle(t, e)
        }, t
    }();
    ...
    var E = function() {
        ...
        Y = function() {
            function t(t, e, i) {
                void 0 === t && (t = {}), this._map = i, this._elements = e, this._values = t.values || {}, this.config = t, this.config.attribute = t.attribute || "fill", t.attributes && this.setAttributes(t.attributes), "object" == typeof t.scale && (this.scale = new X(t.scale)), this.config.legend && (this.legend = new E(u({
                    map: this._map,
                    series: this
    ...
    var T = {
            ...
            bindContainerTouchEvents: function() {
                ...
                w.on(o.container, "touchstart", h), w.on(o.container, "touchmove", h)
            },
            ...
            setScale: function(t, e, i, s, a) {
                ...
                t > this.params.zoomMax * this.baseScale ? t = this.params.zoomMax * this.baseScale : t < this.params.zoomMin * this.baseScale && (t = this.params.zoomMin * this.baseScale), void 0 !== e && void 0 !== i && (n = t / this.scale, s ? (d = e + this.defaultWidth * (this.width / (this.defaultWidth * t)) / 2, f = i + this.defaultHeight * (this.height / (this.defaultHeight * t)) / 2) : (d = this.transX - (n - 1) / t * e, f = this.transY - (n - 1) / t * i)), a && v > 0 ? (o = this.scale, h = (t - o) / v, l = this.transX * this.scale, u = this.transY * this.scale, c = (d * t - l) / v, p = (f * t - u) / v, r = setInterval((function() {
                    g += 1, m.scale = o + h * g, m.transX = (l + c * g) / m.scale, m.transY = (u + p * g) / m.scale, m.applyTransform(), g == v && (clearInterval(r), m.emit(L.onViewportChange, [m.scale, m.transX, m.transY]))
                }), 10)) : (this.transX = d, this.transY = f, this.scale = t, this.applyTransform(), this.emit(L.onViewportChange, [this.scale, this.transX, this.transY]))
            },
            updateSize: function() {
        ...
        D = function() {
            ...
            return e.init = function(t) {
                ...
                })), this.emit(L.onDestroyed), t && s(this).forEach((function(t) {
                    try {
                        delete e[t]
                    } catch (t) {}
                }))
